            ...
            <div className="mb-4">
                <div className="mb-4 flex justify-between items-end">
                    ...
                    {hideDescription && <Link href="/create">
                        <button
                            className="p-1 rounded bg-white text-black font-bold w-full flex justify-between items-center transition hover:opacity-80 active:scale-95 disabled:opacity-50">
